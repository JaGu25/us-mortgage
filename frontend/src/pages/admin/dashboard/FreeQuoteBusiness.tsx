...
import { FREE_QUOTE_BUSINESS, getDataByType, LOAN_BUSINESS } from '../../../helpers/commons'
...
const FreeQuoteBusiness: React.FC = () => {

    const [data, setData] = useState([]);

    useEffect(() => {
        getData(FREE_QUOTE_BUSINESS);
    }, [])
    ...
    return (
        <div>
            <DateRange type={FREE_QUOTE_BUSINESS} />
            <Table title="Free Quote Business" data={data} columns={columns} />
        </div>
    )
}

export default FreeQuoteBusiness
